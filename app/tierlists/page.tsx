...
export default function TierListsPage() {
  ...
  useEffect(() => {
    fetchTierLists()
      .then(setLists)
      .catch((reason) => setError(reason instanceof Error ? reason.message : t("generated.app\\tierlists\\page.failedtoloadtierlists")))

  ...
  return (
    <div className="mx-auto w-full max-w-5xl space-y-6">
      ...
      <section className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        <div className="rounded-xl border border-pc-border bg-pc-bg-elevated p-4"><div className="text-xs text-pc-text-muted">Account level</div><div className="mt-1 text-xl font-semibold text-pc-text">{account.accountLevel.toLocaleString()}</div></div>
        <div className="rounded-xl border border-pc-border bg-pc-bg-elevated p-4"><div className="text-xs text-pc-text-muted">Latest mastery</div><div className="mt-1 text-xl font-semibold text-pc-text">{account.masteryLevel.toLocaleString()}</div></div>
        <div className="rounded-xl border border-pc-border bg-pc-bg-elevated p-4"><div className="text-xs text-pc-text-muted">Latest rank</div><div className={`mt-1 text-xl font-semibold ${getTierColor(account.leagueTier)}`}>{tierName}</div></div>
        <div className="rounded-xl border border-pc-border bg-pc-bg-elevated p-4"><div className="text-xs text-pc-text-muted">Tracked matches</div><div className="mt-1 text-xl font-semibold text-pc-text">{account.matchCount.toLocaleString()}</div></div>
      </section>
          ...
          <div className="overflow-hidden rounded-xl border border-pc-border bg-pc-bg-elevated">
            {observations.map(observation => (
              <Link
                ...
                className="grid gap-2 border-b border-pc-border px-4 py-3 text-sm transition-colors last:border-b-0 hover:bg-pc-bg/50 sm:grid-cols-[minmax(0,1fr)_auto_auto] sm:items-center"
              >
                <div className="min-w-0">
                ...
                <div className="text-xs text-pc-text-secondary">Level {observation.accountLevel} · Mastery {observation.masteryLevel}</div>

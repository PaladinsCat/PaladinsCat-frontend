...
const staticRoutes: Array<{
  ...
  { path: "/stats/dpm", changeFrequency: "hourly", priority: 0.8 },
  { path: "/stats/hpm", changeFrequency: "hourly", priority: 0.8 },
  { path: "/stats/gpm", changeFrequency: "hourly", priority: 0.8 },
  { path: "/stats/mpm", changeFrequency: "hourly", priority: 0.8 },
  { path: "/stats/kda", changeFrequency: "hourly", priority: 0.8 },

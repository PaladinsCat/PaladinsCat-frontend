...
// Keycloak owns identity creation; this page never handles local credentials.
export default function RegisterPage() {
  ...
  return <div className="min-h-[60vh] flex items-center justify-center"><div className="w-full max-w-md bg-pc-bg-elevated rounded-lg border border-pc-border p-6 text-center">
    ...
    <p className="text-pc-text-secondary mt-2 mb-6">{t("generated.auth.joinThePaladinscatCommunity")}</p>

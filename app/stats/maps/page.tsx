...
export default function MapsPage() {
  ...
  return <div className="space-y-6">
    <div><Link href="/stats" className="text-sm text-pc-text-secondary hover:text-pc-accent">{t("generated.stats.globalStats")}</Link><h1 className="mt-3 pc-heading pc-heading-lg text-pc-accent">{t("generated.stats.mapStats")}</h1><p className="mt-1 text-sm text-pc-text-secondary">{t("generated.stats.rankedMapDistributionChampionDraftsTalentsAndItemChoices")}</p></div>

/**
 * Centralize browser requests to the PaladinsCat API and map responses for client consumers.
 *
...
/**
 * Fetch cheater players data for client consumers.
 *
 * Accepts query filters; returns fetchCheaterPlayers data after a backend request, using shared authentication and cache behavior.
 */
...
/**
 * Fetch player profile data for client consumers.
 *
 * Accepts id; returns fetchPlayerProfile data after a backend request, using shared authentication and cache behavior.
 */

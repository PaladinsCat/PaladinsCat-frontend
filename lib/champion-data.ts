...
export const GROVER_DATA: ChampionData = {
  ...
  skills: [
    ...
    },
    {
      ...
      cooldown: "7s",
      description: "Throw a projectile that travels slower but Roots targets affected instead of stunning.",
    },
    {
      name: "Blossom",
      key: "Q",
  ...
  talents: [
    { name: "Wisps of Sylvanus", description: "Blossom's passive aura now also provides 15% Movement Speed.", category: "Blossom", iconUrl: "/images/champions/Talent Grover RampantBlooming.png" },
    ...
    { name: "Deep Roots", description: "Increase the Healing done by Blossom and reduce the Cooldown of Blossom.", category: "Vine", iconUrl: "/images/champions/Talent Grover DeepRoots.png" },
  ],
  loadouts: [
    { name: "Adrenaline", description: "Reduce the Cooldown of Crippling Throw.", category: "Crippling Throw", iconUrl: "/images/cards/Card_Adrenaline.png" },
    { name: "Barkskin", description: "Increase your maximum Health.", category: "", iconUrl: "/images/cards/Card_Barkskin.png" },
    { name: "Chop Down", description: "Reduce the Cooldown of Crippling Throw.", category: "Crippling Throw", iconUrl: "/images/cards/Card_Chop_Down.png" },
    { name: "Chopper", description: "Increase the damage of Crippling Throw.", category: "Crippling Throw", iconUrl: "/images/cards/Card_Chopper.png" },
    { name: "Fatalis", description: "Reduce the Cooldown of Crippling Throw.", category: "Crippling Throw", iconUrl: "/images/cards/Card_Fatalis.png" },
    { name: "Force of Nature", description: "Increase your maximum Health.", category: "", iconUrl: "/images/cards/Card_Force_of_Nature.png" },
    { name: "Gentle Breeze", description: "Increase the healing done by Blossom.", category: "Blossom", iconUrl: "/images/cards/Card_Gentle_Breeze.png" },
    { name: "Heavenly Agility", description: "Increase the Movement Speed of Vine.", category: "Vine", iconUrl: "/images/cards/Card_Heavenly_Agility.png" },
    { name: "Nature's Quickness", description: "Increase the Movement Speed of Vine.", category: "Vine", iconUrl: "/images/cards/Card_Natures_Quickness.png" },
    { name: "Over Growth", description: "Increase the Movement Speed of Vine.", category: "Vine", iconUrl: "/images/cards/Card_Over_Growth.png" },
    { name: "Perennial", description: "Reduce the Cooldown of Blossom.", category: "Blossom", iconUrl: "/images/cards/Card_Perennial.png" },
    { name: "Pick Up", description: "Reduce the Cooldown of Crippling Throw.", category: "Crippling Throw", iconUrl: "/images/cards/Card_Pick_Up.png" },
    { name: "Rebound", description: "Increase your Weapon Damage.", category: "", iconUrl: "/images/cards/Card_Rebound.png" },
    { name: "Unstoppable", description: "Reduce the Cooldown of Blossom.", category: "Blossom", iconUrl: "/images/cards/Card_Unstoppable.png" },
    { name: "Verdant Expanse", description: "Increase the radius of Blossom.", category: "Blossom", iconUrl: "/images/cards/Card_Verdant_Expanse.png" },
    { name: "Vine Grasp", description: "Increase the Movement Speed of Vine.", category: "Vine", iconUrl: "/images/cards/Card_Vine_Grasp.png" },
  ],
};

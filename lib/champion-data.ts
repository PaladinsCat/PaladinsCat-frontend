...
export const LEX_DATA: ChampionData = {
  ...
  loadouts: [
    { name: "Assail", description: "Increase the damage of In Pursuit.", category: "In Pursuit", iconUrl: "/images/cards/Card_Assail.png" },
    { name: "Commencement", description: "Increase the distance of Combat Slide.", category: "Combat Slide", iconUrl: "/images/cards/Card_Commencement.png" },
    { name: "Compel", description: "Reduce the Cooldown of In Pursuit.", category: "In Pursuit", iconUrl: "/images/cards/Card_Compel.png" },
    { name: "Conditioned", description: "Increase the damage you deal.", category: "", iconUrl: "/images/cards/Card_Conditioned.png" },
    { name: "Fortitude", description: "Increase the maximum Health.", category: "In Pursuit", iconUrl: "/images/cards/Card_Fortitude.png" },
    { name: "Hardiness", description: "Increase the damage of In Pursuit.", category: "In Pursuit", iconUrl: "/images/cards/Card_Hardiness.png" },
    { name: "Inescapable", description: "Retribution applies a Slow.", category: "Retribution", iconUrl: "/images/cards/Card_Inescapable.png" },
    { name: "Juke Boots", description: "Increase your Movement Speed.", category: "", iconUrl: "/images/cards/Card_Juke_Boots.png" },
    { name: "Justice Served", description: "Retribution increases damage dealt.", category: "Retribution", iconUrl: "/images/cards/Card_Justice_Served.png" },
    { name: "Keen Sight", description: "Retribution reveals enemies.", category: "Retribution", iconUrl: "/images/cards/Card_Keen_Sight.png" },
    { name: "Requip", description: "Reduce the Cooldown of Combat Slide.", category: "Combat Slide", iconUrl: "/images/cards/Card_Requip.png" },
    { name: "Restock", description: "Increase maximum Ammo.", category: "", iconUrl: "/images/cards/Card_Restock.png" },
    { name: "The Hunted", description: "Retribution increases damage dealt.", category: "Retribution", iconUrl: "/images/cards/Card_The_Hunted.png" },
    { name: "Warrants Out", description: "Increase Movement Speed after Combat Slide ends.", category: "Combat Slide", iconUrl: "/images/cards/Card_Warrants_Out.png" },
    { name: "Well Oiled", description: "Increase the damage you deal.", category: "", iconUrl: "/images/cards/Card_Well_Oiled.png" },
    { name: "Wicked Don't Rest", description: "Reduce the Cooldown of Combat Slide.", category: "Combat Slide", iconUrl: "/images/cards/Card_Wicked_Dont_Rest.png" },
  ],
};
...
export const KOGA_DATA: ChampionData = {
  ...
  loadouts: [
    { name: "Criminal Record", description: "Gain 3.5% Lifesteal while in Dragon Stance.", category: "", iconUrl: "/images/cards/Card_Criminal_Record.png" },
    { name: "Gale Storm", description: "Generate 12.5% Stamina after earning a Killing Blow with Skewer.", category: "", iconUrl: "/images/cards/Card_Gale_Storm.png" },
    { name: "Guild Tactics", description: "Heal for 160 after hitting at least one enemy with Skewer.", category: "", iconUrl: "/images/cards/Card_Guild_Tactics.png" },
    { name: "Harsh Training", description: "Increase your maximum Health by 50.", category: "", iconUrl: "/images/cards/Card_Harsh_Training.png" },
    { name: "Memento", description: "Increase your maximum Ammo by 5.", category: "", iconUrl: "/images/cards/Card_Memento.png" },
    { name: "Raw Talent", description: "Increase the Movement Speed boost of Agility by 4%.", category: "", iconUrl: "/images/cards/Card_Raw_Talent.png" },
    { name: "Something To Prove", description: "Generate 10% Stamina after falling to or below 50% Health.", category: "", iconUrl: "/images/cards/Card_Something_To_Prove.png" },
    { name: "Surprise!", description: "Generate 5 Ammo after activating Shadow Step.", category: "", iconUrl: "/images/cards/Card_Surprise.png" },
    { name: "Swift Hands", description: "While in Dragon Stance, gain 4% Movement Speed.", category: "", iconUrl: "/images/cards/Card_Swift_Hands.png" },
    { name: "Tenacious", description: "Heal for 40 after activating Shadow Step.", category: "", iconUrl: "/images/cards/Card_Tenacious.png" },
    { name: "Trained Killer", description: "While in Dragon Stance regenerate 6 Ammo every 1s.", category: "", iconUrl: "/images/cards/Card_Trained_Killer.png" },
    { name: "Trespasser", description: "Increase your jump height by 20% while Agility is active.", category: "", iconUrl: "/images/cards/Card_Trespasser.png" },
    { name: "Trigger Happy", description: "Increase your Healing received by 5% while firing your SMGs.", category: "", iconUrl: "/images/cards/Card_Trigger_Happy.png" },
    { name: "Unyielding", description: "Reduce the rate of Stamina consumption while in Dragon Stance by 6%.", category: "", iconUrl: "/images/cards/Card_Unyielding.png" },
    { name: "Wanted", description: "Regenerate 4 Ammo every 1s while Agility is active.", category: "", iconUrl: "/images/cards/Card_Wanted.png" },
    { name: "Wind's Embrace", description: "Heal for 20 every 1s while Agility is active.", category: "", iconUrl: "/images/cards/Card_Wind_Embrace.png" },
  ],
};
...
export const VATU_DATA: ChampionData = {
  ...
  loadouts: [
    ...
    { name: "Final Sight", description: "Reset the Cooldown of Ambush after falling to or below 10% Health.", category: "", iconUrl: "/images/cards/Card_Final_Sight.png" },
    ...
    { name: "Memento Vivere", description: "Increase your maximum Health by 40.", category: "", iconUrl: "/images/cards/Card_Memento_Vivere.png" },
    ...
    { name: "Shadow Garrote", description: "Generate 5% Ultimate charge for each enemy hit with your Ultimate.", category: "", iconUrl: "/images/cards/Card_Shadow_Garrote.png" },
    ...
    { name: "Tranquility", description: "Increase your base jump height by 30%.", category: "", iconUrl: "/images/cards/Card_Tranquility.png" },
  ],
};
...
export const VORA_DATA: ChampionData = {
  ...
  loadouts: [
    ...
    { name: "False Idol", description: "Increase your Movement Speed by 7% and gain 10% Lifesteal for 5s after falling to or below 40% Health.", category: "", iconUrl: "/images/cards/Card_False_Idol.png" },
    ...
    { name: "New Purpose", description: "Increase your maximum Health by 50.", category: "", iconUrl: "/images/cards/Card_New_Purpose.png" },
    ...
    { name: "Sharpened Resolve", description: "Consuming Darkness stacks Heals you for an additional 10 per stack.", category: "", iconUrl: "/images/cards/Card_Sharpened_Resolve.png" },
    { name: "The Maw's Embrace", description: "Increase your Movement Speed by 6% for 1s after hitting anything with Deadly Scythe.", category: "", iconUrl: "/images/cards/Card_Maws_Embrace.png" },
...
export const ZHIN_DATA: ChampionData = {
  ...
  loadouts: [
    ...
    { name: "Dragon Oil", description: "Increase your maximum Ammo by 1.", category: "", iconUrl: "/images/cards/Card_Dragon_Oil.png" },
    ...
    { name: "Heartless", description: "Increase your Movement Speed by 6% for 4s after getting an Elimination.", category: "", iconUrl: "/images/cards/Card_Heartless.png" },
    ...
    { name: "Infamy", description: "Increase your maximum Health by 50.", category: "", iconUrl: "/images/cards/Card_Infamy.png" },
    { name: "Kindling", description: "Generate 1 Ammo after activating Whirl.", category: "Whirl", iconUrl: "/images/cards/Card_Kindling.png" },
    { name: "Malice", description: "Increase your Reload Speed by 10%.", category: "", iconUrl: "/images/cards/Card_Malice.png" },

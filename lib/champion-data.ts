...
export const FURIA_DATA: ChampionData = {
  ...
  skills: [
    ...
    },
    {
      ...
      cooldown: "12s",
      description: "Throw a projectile that explodes on impact, stunning enemies in an area and dealing damage.",
    },
    {
      name: "Wings of Wrath",
      key: "F",
  ...
  loadouts: [
    { name: "Burning Oath", description: "Increase the initial burst healing of Kindle Soul.", category: "Kindle Soul", iconUrl: "/images/cards/Card_Burning_Oath.png" },
    { name: "Conviction", description: "Increase the duration of Pyre Strike.", category: "Pyre Strike", iconUrl: "/images/cards/Card_Conviction.png" },
    { name: "Devout Dexterity", description: "Increase your maximum Ammo.", category: "", iconUrl: "/images/cards/Card_Devout_Dexterity.png" },
    { name: "Fire Siphon", description: "Increase the damage of Wings of Wrath projectiles.", category: "Wings of Wrath", iconUrl: "/images/cards/Card_Fire_Siphon.png" },
    { name: "Hallowed Sight", description: "Increase the range of Pyre Strike.", category: "Pyre Strike", iconUrl: "/images/cards/Card_Hallowed_Sight.png" },
    { name: "Ignition", description: "Reduce the Cooldown of Pyre Strike.", category: "Pyre Strike", iconUrl: "/images/cards/Card_Ignition.png" },
    { name: "Incandescent Being", description: "Increase your maximum Health.", category: "", iconUrl: "/images/cards/Card_Incandescent_Being.png" },
    { name: "Inner Fire", description: "Increase the over-time healing of Kindle Soul.", category: "Kindle Soul", iconUrl: "/images/cards/Card_Inner_Fire.png" },
    { name: "Light Forge", description: "Increase the healing done by Kindle Soul.", category: "Kindle Soul", iconUrl: "/images/cards/Card_Light_Forge.png" },
    { name: "Light of Dawn", description: "Increase the initial burst healing of Kindle Soul.", category: "Kindle Soul", iconUrl: "/images/cards/Card_Light_of_Dawn.png" },
    { name: "Pyre Walker", description: "Reduce the Cooldown of Wings of Wrath.", category: "Wings of Wrath", iconUrl: "/images/cards/Card_Pyre_Walker.png" },
    { name: "Pyretic Dynamo", description: "Increase your maximum Ammo.", category: "", iconUrl: "/images/cards/Card_Pyretic_Dynamo.png" },
    { name: "Righteous Path", description: "Increase the Movement Speed of Wings of Wrath.", category: "Wings of Wrath", iconUrl: "/images/cards/Card_Righteous_Path.png" },
    { name: "Ruthless", description: "Increase your Weapon Damage.", category: "", iconUrl: "/images/cards/Card_Ruthless.png" },
    { name: "Solar Flare", description: "Increase the damage of Pyre Strike.", category: "Pyre Strike", iconUrl: "/images/cards/Card_Solar_Flare.png" },
    { name: "Stoke the Fire", description: "Reduce the Cooldown of Wings of Wrath.", category: "Wings of Wrath", iconUrl: "/images/cards/Card_Stoke_the_Fire.png" },
  ],
};

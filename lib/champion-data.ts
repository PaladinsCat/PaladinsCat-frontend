  ...
  skills: [
    {
      name: "Caustic Spray",
      key: "LMB",
      iconUrl: "/images/skills/Ability_Caustic_Spray.png",
      description: "Planted: Spray acid, dealing damage and leaving behind pools of acid.",
    },
    {
      name: "Trail of Acid",
      key: "LMB",
      iconUrl: "/images/skills/Ability_Trail_of_Acid.png",
      description: "Travel: Leave a series of acid pools behind as you roll.",
    },
    {
      ...
      cooldown: "0.5s",
      description: "Planted: Fire Piercing Quills that deal damage and explode in a small area.",
    },
    {
      name: "Acceleration",
      key: "RMB",
      iconUrl: "/images/skills/Ability_Acceleration.png",
      cooldown: "12s",
      description: "Travel: Charge forward through enemies, dealing damage and Knocking them back.",
    },
    {
      name: "Hardening",
      key: "Q",
      ...
      cooldown: "15s",
      description: "Planted: Reduce the damage you take for up to 4s and deal damage to nearby enemies.",
    },
    {
      name: "Primal Vision",
      key: "Q",
      iconUrl: "/images/skills/Ability_Primal_Vision.png",
      cooldown: "11s",
      description: "Travel: Pulse 5 times, briefly Revealing nearby enemies to allies.",
    },
    {
      name: "Form Swap",
      key: "F",
    ...
    },
    {
      ...
      cooldown: "Ultimate",
      description: "Target an enemy to pull in and devour them, gaining a new Health pool while doing so.",
    },
  ],
  talents: [
    { name: "Corrosive Acid", description: "Increase the damage done by Caustic Spray to 42, and your acid pools to 40. Allies within your acid pools have their Movement Speed increased by 20%.", category: "Caustic Spray", iconUrl: "/images/champions/Talent Yagorath Corrosive Acid.png" },
    { name: "Sight Begets Strength", description: "Allied players within range of your Primal Vision gain a stackable 100-Health Shield and 15% increased Movement Speed for 5s each time you pulse.", category: "Primal Vision", iconUrl: "/images/champions/Talent Yagorath Sight Begets Strength.png" },
    { name: "Unnatural Persistence", description: "While in Hardening, increase your Healing received from others by 50%.", category: "Hardening", iconUrl: "/images/champions/Talent Yagorath Unnatural Persistence.png" },
  ],
  cards: [
    { name: "Ancient Wounds", values: ["1.5%", "3%", "4.5%", "6%", "7.5%"], category: "Piercing Quills", iconUrl: "/images/cards/Card_Ancient_Wounds.png" },
    { name: "Collateral Damage", values: ["10%", "20%", "30%", "40%", "50%"], category: "Form Swap", iconUrl: "/images/cards/Card_Collateral_Damage.png" },
    { name: "Deadly Predator", values: ["7%", "14%", "21%", "28%", "35%"], category: "", iconUrl: "/images/cards/Card_Deadly_Predator.png" },
    { name: "Deadly Pursuit", values: ["1s", "2s", "3s", "4s", "5s"], category: "Form Swap", iconUrl: "/images/cards/Card_Deadly_Pursuit.png" },
    { name: "Dreadful Compact", values: ["-0.3s", "-0.5s", "-0.8s", "-1s", "-1.3s"], category: "Piercing Quills", iconUrl: "/images/cards/Card_Dreadful_Compact.png" },
    { name: "End Of An Era", values: ["-20%", "-40%", "-60%", "-80%", "-100%"], category: "Hardening", iconUrl: "/images/cards/Card_End_Of_An_Era.png" },
    { name: "Extermination", values: ["-5%", "-10%", "-15%", "-20%", "-25%"], category: "", iconUrl: "/images/cards/Card_Extermination.png" },
    { name: "Futile Efforts", values: ["10%", "20%", "30%", "40%", "50%"], category: "", iconUrl: "/images/cards/Card_Futile_Efforts.png" },
    { name: "Last Efforts", values: ["0.6s", "1.2s", "1.8s", "2.4s", "3s"], category: "Piercing Quills", iconUrl: "/images/cards/Card_Last_Efforts.png" },
    { name: "Out Of Time", values: ["-0.5", "-1", "-1.5", "-2", "-2.5"], category: "Hardening", iconUrl: "/images/cards/Card_Out_Of_Time.png" },
    { name: "Raze and Burn", values: ["50", "100", "150", "200", "250"], category: "Piercing Quills", iconUrl: "/images/cards/Card_Raze_and_Burn.png" },
    { name: "Spreading Domain", values: ["100", "200", "300", "400", "500"], category: "Hardening", iconUrl: "/images/cards/Card_Spreading_Domain.png" },
    { name: "The Great Worm", values: ["80", "160", "240", "320", "400"], category: "Form Swap", iconUrl: "/images/cards/Card_The_Great_Worm.png" },
    { name: "Towering Presence", values: ["200", "400", "600", "800", "1000"], category: "", iconUrl: "/images/cards/Card_Towering_Presence.png" },
    { name: "Triumphant Return", values: ["-0.4%", "-0.8%", "-1.2%", "-1.6%", "-2%"], category: "Form Swap", iconUrl: "/images/cards/Card_Triumphant_Return.png" },
    { name: "Violent Birth", values: ["-0.8s", "-1.6s", "-2.4s", "-3.2s", "-4s"], category: "Hardening", iconUrl: "/images/cards/Card_Violent_Birth.png" },
  ],
};

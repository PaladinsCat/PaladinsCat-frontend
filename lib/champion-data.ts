...
export const GROHK_DATA: ChampionData = {
  ...
  skills: [
    ...
    },
    {
      ...
      cooldown: "6s",
      description: "Shoot a projectile that, if it lands on an enemy, will bounce to and damage other nearby enemies as well.",
    },
    {
      name: "Healing Totem",
      key: "Q",
    ...
    },
    {
      ...
      cooldown: "Ultimate",
      description: "Take to the sky and fire lightning bolts that damage and slow enemies, while speeding up and healing allies as well as yourself.",
    },
  ],
  talents: [
  ...
  loadouts: [
    { name: "Arc Lightning", description: "Shock Pulse chains to an additional target.", category: "Shock Pulse", iconUrl: "/images/cards/Card_Arc_Lightning.png" },
    { name: "Astral Traveler", description: "Increase the Movement Speed of Ghost Walk.", category: "Ghost Walk", iconUrl: "/images/cards/Card_Astral_Traveler.png" },
    { name: "Conduit", description: "Shock Pulse chains to an additional target.", category: "Shock Pulse", iconUrl: "/images/cards/Card_Conduit.png" },
    { name: "Crackle", description: "Increase the duration of Healing Totem.", category: "Healing Totem", iconUrl: "/images/cards/Card_Crackle.png" },
    { name: "Electrostatic", description: "Increase your Weapon Damage.", category: "", iconUrl: "/images/cards/Card_Electrostatic.png" },
    { name: "Gale", description: "Increase the duration of Ghost Walk.", category: "Ghost Walk", iconUrl: "/images/cards/Card_Gale.png" },
    { name: "Haunting", description: "Reduce the Cooldown of Ghost Walk.", category: "Ghost Walk", iconUrl: "/images/cards/Card_Haunting.png" },
    { name: "Lightning Rod", description: "Increase the damage of Shock Pulse.", category: "Shock Pulse", iconUrl: "/images/cards/Card_Lightning_Rod.png" },
    { name: "Monolith Totem", description: "Increase the healing done by Healing Totem.", category: "Healing Totem", iconUrl: "/images/cards/Card_Monolith_Totem.png" },
    { name: "Outreach", description: "Increase the radius of Healing Totem.", category: "Healing Totem", iconUrl: "/images/cards/Card_Outreach.png" },
    { name: "Phantom", description: "Increase the duration of Ghost Walk.", category: "Ghost Walk", iconUrl: "/images/cards/Card_Phantom.png" },
    { name: "Shamanic Might", description: "Increase your maximum Health.", category: "", iconUrl: "/images/cards/Card_Shamanic_Might.png" },
    { name: "Spirit's Grace", description: "Increase the healing done by Healing Totem.", category: "Healing Totem", iconUrl: "/images/cards/Card_Spirits_Grace.png" },
    { name: "Thunderlord", description: "Increase your Weapon Damage.", category: "", iconUrl: "/images/cards/Card_Thunderlord.png" },
    { name: "Thunderstruck", description: "Shock Pulse chains to an additional target.", category: "Shock Pulse", iconUrl: "/images/cards/Card_Thunderstruck.png" },
    { name: "Totemic Rescue", description: "Dropping below 30% of your max Health grants you a Health Shield.", category: "", iconUrl: "/images/cards/Card_Totemic_Rescue.png" },
  ],
};

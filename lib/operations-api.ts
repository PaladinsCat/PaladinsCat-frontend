...
/**
 * Performs the fetch public operations stats operation with this module's boundary checks.
 * Returns: `Promise<PublicOperationsStats>`
 */
...
/**
 * Performs the list tickets operation with this module's boundary checks.
 */
...
/**
 * Performs the create ticket operation with this module's boundary checks.
 */
...
/**
 * Reads ticket from the module's configured source.
 */
...
/**
 * Performs the comment ticket operation with this module's boundary checks.
 */
...
/**
 * Performs the update ticket operation with this module's boundary checks.
 */
...
/**
 * Performs the delete ticket operation with this module's boundary checks.
 */
...
/**
 * Performs the list work items operation with this module's boundary checks.
 */
export async function listWorkItems() { return fetchJson<WorkItem[]>("/projects", { headers: auth() }); }
/**
 * Performs the create work item operation with this module's boundary checks.
 */
...
/**
 * Performs the update work item operation with this module's boundary checks.
 */

...
interface ClassMetric {
  ...
  min: number;
  max: number;
  champions: Array<{ name: string; value: number; matches: number; min: number; max: number; median: number; mode: number }>;
}
...
export const MOCK_METRIC_BY_CLASS: Record<string, Record<string, ClassMetric>> = {
  dpm: {
    Frontline: {
      ...
      champions: [
        { name: "Raum", value: 680, matches: 8_420, min: 633, max: 735, median: 625, mode: 578 },
        { name: "Terminus", value: 610, matches: 6_310, min: 542, max: 657, median: 561, mode: 518 },
        { name: "Ash", value: 540, matches: 7_890, min: 395, max: 576, median: 496, mode: 459 },
        { name: "Khan", value: 490, matches: 9_120, min: 487, max: 573, median: 450, mode: 416 },
        { name: "Ruckus", value: 460, matches: 5_640, min: 342, max: 546, median: 423, mode: 391 },
      ],
    },
    Damage: {
      className: "Damage", avg: 890, min: 520, max: 1_420,
      champions: [
        { name: "Drogoz", value: 1_420, matches: 11_240, min: 1_192, max: 1_435, median: 1_306, mode: 1_207 },
        { name: "Lian", value: 1_280, matches: 14_560, min: 1_069, max: 1_501, median: 1_177, mode: 1_088 },
        { name: "Cassie", value: 1_150, matches: 12_890, min: 916, max: 1_270, median: 1_058, mode: 977 },
        { name: "Viktor", value: 1_040, matches: 16_320, min: 808, max: 1_240, median: 956, mode: 884 },
        { name: "Tyra", value: 980, matches: 10_470, min: 710, max: 1_270, median: 901, mode: 833 },
      ],
    },
    Flank: {
      className: "Flank", avg: 720, min: 340, max: 1_180,
      champions: [
        { name: "Androxus", value: 1_180, matches: 13_450, min: 1_109, max: 1_202, median: 1_085, mode: 1_003 },
        { name: "Evie", value: 1_020, matches: 8_920, min: 980, max: 1_225, median: 938, mode: 867 },
        { name: "Maeve", value: 940, matches: 11_340, min: 825, max: 1_027, median: 864, mode: 799 },
        { name: "Zhin", value: 810, matches: 9_780, min: 702, max: 1_015, median: 745, mode: 688 },
        { name: "Koga", value: 760, matches: 7_560, min: 615, max: 762, median: 699, mode: 646 },
      ],
    },
    Support: {
      className: "Support", avg: 280, min: 85, max: 520,
      champions: [
        { name: "Grohk", value: 520, matches: 6_230, min: 408, max: 574, median: 478, mode: 442 },
        { name: "Furia", value: 480, matches: 8_910, min: 380, max: 550, median: 441, mode: 408 },
        { name: "Grover", value: 340, matches: 7_450, min: 274, max: 350, median: 312, mode: 289 },
        { name: "Corvus", value: 290, matches: 5_120, min: 244, max: 324, median: 266, mode: 246 },
        { name: "Jenos", value: 210, matches: 9_340, min: 157, max: 259, median: 193, mode: 178 },
      ],
    },
  },
  hpm: {
    Frontline: {
      ...
      champions: [
        { name: "Terminus", value: 780, matches: 6_310, min: 580, max: 869, median: 717, mode: 663 },
        { name: "Inara", value: 540, matches: 7_120, min: 379, max: 662, median: 496, mode: 459 },
        { name: "Nyx", value: 420, matches: 4_890, min: 340, max: 493, median: 386, mode: 357 },
        { name: "Fernando", value: 280, matches: 11_240, min: 264, max: 301, median: 257, mode: 238 },
        { name: "Ash", value: 120, matches: 7_890, min: 89, max: 150, median: 110, mode: 102 },
      ],
    },
    Damage: {
      className: "Damage", avg: 45, min: 0, max: 180,
      champions: [
        { name: "Tyra", value: 180, matches: 10_470, min: 156, max: 206, median: 165, mode: 153 },
        { name: "Vivian", value: 120, matches: 6_890, min: 111, max: 146, median: 110, mode: 102 },
        { name: "Viktor", value: 85, matches: 16_320, min: 47, max: 133, median: 78, mode: 72 },
        { name: "Lian", value: 20, matches: 14_560, min: 0, max: 39, median: 18, mode: 17 },
        { name: "Drogoz", value: 0, matches: 11_240, min: 0.0, max: 0.0, median: 0.0, mode: 0.0 },
      ],
    },
    Flank: {
      className: "Flank", avg: 60, min: 0, max: 240,
      champions: [
        { name: "Buck", value: 240, matches: 5_340, min: 199, max: 250, median: 220, mode: 204 },
        { name: "Skye", value: 160, matches: 6_120, min: 114, max: 192, median: 147, mode: 136 },
        { name: "Maeve", value: 45, matches: 11_340, min: 20, max: 54, median: 41, mode: 38 },
        { name: "Androxus", value: 20, matches: 13_450, min: 0, max: 52, median: 18, mode: 17 },
        { name: "Evie", value: 0, matches: 8_920, min: 0.0, max: 0.0, median: 0.0, mode: 0.0 },
      ],
    },
    Support: {
      className: "Support", avg: 3_240, min: 980, max: 5_800,
      champions: [
        { name: "Seris", value: 5_800, matches: 15_240, min: 5_224, max: 7_127, median: 5_336, mode: 4_930 },
        { name: "Io", value: 4_620, matches: 12_890, min: 3_898, max: 5_099, median: 4_250, mode: 3_927 },
        { name: "Grover", value: 4_180, matches: 7_450, min: 3_448, max: 4_628, median: 3_845, mode: 3_553 },
        { name: "Ying", value: 3_540, matches: 11_340, min: 3_407, max: 4_200, median: 3_256, mode: 3_009 },
        { name: "Mal Damba", value: 2_980, matches: 8_120, min: 2_363, max: 3_335, median: 2_741, mode: 2_533 },
      ],
    },
  },
  gpm: {
    Frontline: {
      ...
      champions: [
        { name: "Khan", value: 2_340, matches: 9_120, min: 2_262, max: 2_351, median: 2_152, mode: 1_989 },
        { name: "Fernando", value: 2_180, matches: 11_240, min: 2_032, max: 2_405, median: 2_005, mode: 1_853 },
        { name: "Barik", value: 1_920, matches: 8_450, min: 1_584, max: 1_930, median: 1_766, mode: 1_632 },
        { name: "Inara", value: 1_680, matches: 7_120, min: 1_591, max: 1_820, median: 1_545, mode: 1_428 },
        { name: "Raum", value: 1_420, matches: 8_420, min: 1_271, max: 1_685, median: 1_306, mode: 1_207 },
      ],
    },
    Damage: {
      className: "Damage", avg: 2_140, min: 1_420, max: 3_600,
      champions: [
        { name: "Lian", value: 3_600, matches: 14_560, min: 3_173, max: 3_749, median: 3_312, mode: 3_060 },
        { name: "Cassie", value: 3_120, matches: 12_890, min: 2_277, max: 3_159, median: 2_870, mode: 2_652 },
        { name: "Viktor", value: 2_840, matches: 16_320, min: 2_632, max: 2_860, median: 2_612, mode: 2_414 },
        { name: "Kinessa", value: 2_480, matches: 9_340, min: 2_248, max: 2_974, median: 2_281, mode: 2_108 },
        { name: "Drogoz", value: 2_280, matches: 11_240, min: 2_142, max: 2_619, median: 2_097, mode: 1_938 },
      ],
    },
    Flank: {
      className: "Flank", avg: 1_980, min: 1_120, max: 3_240,
      champions: [
        { name: "Androxus", value: 3_240, matches: 13_450, min: 2_989, max: 3_700, median: 2_980, mode: 2_754 },
        { name: "Maeve", value: 2_860, matches: 11_340, min: 2_631, max: 3_457, median: 2_631, mode: 2_431 },
        { name: "Evie", value: 2_420, matches: 8_920, min: 2_152, max: 2_823, median: 2_226, mode: 2_057 },
        { name: "Zhin", value: 2_180, matches: 9_780, min: 1_802, max: 2_577, median: 2_005, mode: 1_853 },
        { name: "Koga", value: 1_840, matches: 7_560, min: 1_791, max: 1_842, median: 1_692, mode: 1_564 },
      ],
    },
    Support: {
      className: "Support", avg: 1_480, min: 820, max: 2_240,
      champions: [
        { name: "Furia", value: 2_240, matches: 8_910, min: 1_804, max: 2_598, median: 2_060, mode: 1_904 },
        { name: "Grohk", value: 1_980, matches: 6_230, min: 1_844, max: 2_064, median: 1_821, mode: 1_683 },
        { name: "Jenos", value: 1_620, matches: 9_340, min: 1_549, max: 1_804, median: 1_490, mode: 1_377 },
        { name: "Seris", value: 1_340, matches: 15_240, min: 1_226, max: 1_467, median: 1_232, mode: 1_139 },
        { name: "Io", value: 1_120, matches: 12_890, min: 1_070, max: 1_179, median: 1_030, mode: 952 },
      ],
    },
  },
  mpm: {
    Frontline: {
      ...
      champions: [
        { name: "Inara", value: 4_200, matches: 7_120, min: 3_607, max: 4_340, median: 3_864, mode: 3_570 },
        { name: "Terminus", value: 3_640, matches: 6_310, min: 2_738, max: 4_509, median: 3_348, mode: 3_094 },
        { name: "Nyx", value: 2_840, matches: 4_890, min: 2_718, max: 2_943, median: 2_612, mode: 2_414 },
        { name: "Barik", value: 1_980, matches: 8_450, min: 1_806, max: 2_224, median: 1_821, mode: 1_683 },
        { name: "Fernando", value: 1_420, matches: 11_240, min: 1_404, max: 1_423, median: 1_306, mode: 1_207 },
      ],
    },
    Damage: {
      className: "Damage", avg: 18, min: 0, max: 85,
      champions: [
        { name: "Vivian", value: 85, matches: 6_890, min: 76, max: 111, median: 78, mode: 72 },
        { name: "Viktor", value: 42, matches: 16_320, min: 4, max: 90, median: 38, mode: 35 },
        { name: "Tyra", value: 15, matches: 10_470, min: 0, max: 61, median: 13, mode: 12 },
        { name: "Lian", value: 0, matches: 14_560, min: 0.0, max: 0.0, median: 0.0, mode: 0.0 },
        { name: "Cassie", value: 0, matches: 12_890, min: 0.0, max: 0.0, median: 0.0, mode: 0.0 },
      ],
    },
    Flank: {
      className: "Flank", avg: 25, min: 0, max: 180,
      champions: [
        { name: "Vora", value: 180, matches: 6_120, min: 129, max: 226, median: 165, mode: 153 },
        { name: "Zhin", value: 95, matches: 9_780, min: 49, max: 100, median: 87, mode: 80 },
        { name: "Vatu", value: 35, matches: 5_340, min: 25, max: 71, median: 32, mode: 29 },
        { name: "Maeve", value: 0, matches: 11_340, min: 0.0, max: 0.0, median: 0.0, mode: 0.0 },
        { name: "Androxus", value: 0, matches: 13_450, min: 0.0, max: 0.0, median: 0.0, mode: 0.0 },
      ],
    },
    Support: {
      className: "Support", avg: 85, min: 0, max: 420,
      champions: [
        { name: "Io", value: 420, matches: 12_890, min: 328, max: 521, median: 386, mode: 357 },
        { name: "Grover", value: 280, matches: 7_450, min: 202, max: 302, median: 257, mode: 238 },
        { name: "Furia", value: 120, matches: 8_910, min: 96, max: 144, median: 110, mode: 102 },
        { name: "Seris", value: 45, matches: 15_240, min: 0, max: 92, median: 41, mode: 38 },
        { name: "Jenos", value: 0, matches: 9_340, min: 0.0, max: 0.0, median: 0.0, mode: 0.0 },
      ],
    },
  },
  kda: {
    Frontline: {
      ...
      champions: [
        { name: "Khan", value: 2.8, matches: 9_120, min: 1.1, max: 5.0, median: 2.7, mode: 2.4 },
        { name: "Fernando", value: 2.4, matches: 11_240, min: 1.0, max: 4.3, median: 2.3, mode: 2.0 },
        { name: "Ash", value: 2.1, matches: 7_890, min: 0.8, max: 3.8, median: 2.0, mode: 1.8 },
        { name: "Barik", value: 1.9, matches: 8_450, min: 0.8, max: 3.4, median: 1.8, mode: 1.6 },
        { name: "Inara", value: 1.4, matches: 7_120, min: 0.6, max: 2.5, median: 1.3, mode: 1.2 },
      ],
    },
    Damage: {
      className: "Damage", avg: 2.4, min: 1.2, max: 3.8,
      champions: [
        { name: "Lian", value: 3.8, matches: 14_560, min: 1.5, max: 6.8, median: 3.6, mode: 3.2 },
        { name: "Cassie", value: 3.4, matches: 12_890, min: 1.4, max: 6.1, median: 3.2, mode: 2.9 },
        { name: "Kinessa", value: 3.1, matches: 9_340, min: 1.2, max: 5.6, median: 2.9, mode: 2.6 },
        { name: "Viktor", value: 2.6, matches: 16_320, min: 1.0, max: 4.7, median: 2.5, mode: 2.2 },
        { name: "Drogoz", value: 2.2, matches: 11_240, min: 0.9, max: 4.0, median: 2.1, mode: 1.9 },
      ],
    },
    Flank: {
      className: "Flank", avg: 2.6, min: 1.1, max: 4.2,
      champions: [
        { name: "Androxus", value: 4.2, matches: 13_450, min: 1.7, max: 7.6, median: 4.0, mode: 3.6 },
        { name: "Evie", value: 3.8, matches: 8_920, min: 1.5, max: 6.8, median: 3.6, mode: 3.2 },
        { name: "Maeve", value: 3.4, matches: 11_340, min: 1.4, max: 6.1, median: 3.2, mode: 2.9 },
        { name: "Vatu", value: 2.8, matches: 5_340, min: 1.1, max: 5.0, median: 2.7, mode: 2.4 },
        { name: "Zhin", value: 2.1, matches: 9_780, min: 0.8, max: 3.8, median: 2.0, mode: 1.8 },
      ],
    },
    Support: {
      className: "Support", avg: 2.1, min: 0.8, max: 3.6,
      champions: [
        { name: "Furia", value: 3.6, matches: 8_910, min: 1.4, max: 6.5, median: 3.4, mode: 3.1 },
        { name: "Grohk", value: 2.9, matches: 6_230, min: 1.2, max: 5.2, median: 2.8, mode: 2.5 },
        { name: "Jenos", value: 2.4, matches: 9_340, min: 1.0, max: 4.3, median: 2.3, mode: 2.0 },
        { name: "Ying", value: 2.0, matches: 11_340, min: 0.8, max: 3.6, median: 1.9, mode: 1.7 },
        { name: "Seris", value: 1.5, matches: 15_240, min: 0.6, max: 2.7, median: 1.4, mode: 1.3 },
      ],
    },
  },
};

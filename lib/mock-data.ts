...
export const MOCK_ITEM_STATS = [
  { name: "Cauterize", pickRate: 92.4, winRate: 51.2, category: "Offense", icon: "/images/items/Cauterize_Icon.avif" },
  ...
  { name: "Veteran", pickRate: 8.2, winRate: 46.1, category: "Defense", icon: "/images/items/Veteran_Icon.avif" },
  { name: "Resilience", pickRate: 52.3, winRate: 50.7, category: "Utility", icon: "/images/items/Resilience_Icon.avif" },
  ...
  { name: "Illuminate", pickRate: 34.6, winRate: 53.1, category: "Utility", icon: "/images/items/Illuminate_Icon.avif" },
  ...
  { name: "Kill to Heal", pickRate: 29.1, winRate: 49.4, category: "Healing", icon: "/images/items/Kill_to_Heal_Icon.avif" },

  ...
  return (
    <div className="relative z-40 border-b border-pc-accent/20 bg-pc-bg-secondary/95 shadow-sm backdrop-blur">
      <div className="mx-auto flex min-h-11 max-w-7xl items-center gap-3 px-4 py-2 sm:px-6 lg:px-8">
          ...
          {LOBBY_TIER_OPTIONS.map((option) => {
            ...
            return (
              <button
                ...
                className={`rounded-md px-2.5 py-1 text-xs font-semibold transition-colors disabled:cursor-wait disabled:opacity-50 ${
                  selected
        ...
        <Link href="/account" className="hidden shrink-0 text-xs text-pc-text-muted transition-colors hover:text-pc-accent sm:inline">

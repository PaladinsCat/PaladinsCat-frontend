            ...
            <div className="flex shrink-0 items-center justify-end gap-4" suppressHydrationWarning>
              ...
              {resolvedUser ? (
                ...
                <form action="/api/auth/oidc/login" method="post">
                  ...
                  <button type="submit" className="pc-btn-secondary text-sm">{t("nav.login")}</button>
                </form>
              )}
            </div>
          </div>

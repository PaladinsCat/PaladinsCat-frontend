/**
 * Render wall shooter directory with `PlayersPageHeader`, `TagCriteriaTip`, `PlayerDirectorySearch`, `LoadingPanel`, `PlayerDirectoryPagination`.
 * refs: none
 */
"use client";
...
export default function WallShooterDirectory() {
  ...
  return (
    <div className="space-y-6">
      <PlayersPageHeader title={t("moderation.wallShooterTitle")} description={t("moderation.wallShooterDescription")} />
      <TagCriteriaTip criteriaKey="moderation.wallShooterNotice" />

...
/** Render an accessible loading placeholder with optional additional classes. */
export function Skeleton({ className }: { className?: string }) {
  return <div aria-hidden="true" className={cn("pc-skeleton rounded-lg", className)} />;
}

/** Render a full-width short loading line by composing Skeleton with height classes. */
